...
function loadHeaderAndFooter() {
    ...
    <li><a href="${window.buildWhatsAppUrl()}" target="_blank" rel="noopener noreferrer" data-fwk-handoff="header" onclick="trackContactConversion('', {link_target:'header_contact'});">Contact</a></li>            </ul>
        ...
        // The mark, then the three ways to reach us in the order they are used,
        // then the legal line. See the footer block in css/styles.css.
        const footerContent = `
        <div class="footer-content">
            <p class="footer-brand"><img src="/images/global/fwk-icon.png" alt="Framework Designs" width="30" height="30"><span>Made in Nairobi</span></p>
            <dl class="footer-contact">
                <div class="footer-wa"><dt>WhatsApp</dt><dd><a href="${window.buildWhatsAppUrl()}" target="_blank" rel="noopener noreferrer" data-fwk-handoff="footer" onclick="trackContactConversion('', {link_target:'footer_whatsapp'});">+254 783 891 005</a></dd></div>
                <div><dt>Email</dt><dd><a href="mailto:info@framework.co.ke">info@framework.co.ke</a></dd></div>
                <div><dt>Instagram</dt><dd><a href="https://www.instagram.com/framework_nairobi/" target="_blank" rel="noopener noreferrer">framework_nairobi</a></dd></div>
            </dl>
            <p class="footer-legal">© ${new Date().getFullYear()} Framework Designs Limited</p>
        </div>
    `;
